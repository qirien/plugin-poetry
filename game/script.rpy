...
init python:
    ...
    ADJECTIVES = ["beautiful", "blue", "gray", "crimson", "soft", "feathery", "tiny", "young", "gentle", "old", "pink", "rosy", "your", "my", "our", "happy", "simple", "slow", "green", "personal", "bright", "clever", "cute", "chubby", "jealous", "next", "tender", "tight", "precious", "orange", "sweet", "this", "my"]
    ...
    OTHER = ["in", "on", "after", "before", "for", "of", "and", "the", "-ing", "-ly", "!", "?", "-s", "forever", "every", "from", "oh", "around", "between", "after", "-y"]
    MAX_LINES = 5
    MAX_POEMS = 5
